...
/*		
	...
	*/	
    ...
    function options_page()
    {
		...
		<iframe width=270 height=800 frameborder="0" src="http://gooyahbing.com/plugins/wpqdr.html"></iframe>
 		</div>
		...
		<tr><td>
			...
			<p>You can now easily add your own plugins to your installation and manage them right here. If you need to delete one of the plugins, please go to the table below.</p>
		   	...
		   	<li><label for="piurl"><strong>Plugin URL</strong> (WP plugin directory url - include "http://")</label><br />
